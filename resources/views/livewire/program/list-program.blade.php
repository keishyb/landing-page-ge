    ...
    <x-main.main-template>
        <div class="my-16 mx-10">
            <div class="flex justify-between mb-5">
                <h1 class="text-3xl font-bold">List Program</h1>
            ...
            duration-300"
                    href="{{ route('create-program') }}">CREATE</a>
            </div>
            <table id="table-data" class="border-collapse w-full">
                <thead>
                    <tr class=" bg-gradient-to-r from-yellow-500 to-yellow-600">
                        <th class="p-3 font-bold uppercase text-white border-gray-300 hidden lg:table-cell">judul</th>
                        <th class="p-3 font-bold uppercase text-white border-gray-300 hidden lg:table-cell">deskripsi</th>
            ...
            <tr class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                ...
                <a class="my-2 border px-3 py-2 rounded-lg text-white text-sm bg-yellow-600" href="{{ route('edit-program', $item->id) }}">edit</a>
                <a class="my-2 border px-3 py-2 rounded-lg text-white text-sm bg-red-600" href="{{ route('delete-program', $item->id) }}">delete</a></td>
            </tr>
            @endforeach
                </tbody>
            </table>
