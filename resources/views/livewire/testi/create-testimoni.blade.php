          ...
          <div class=" bg-white shadow-2xl rounded-lg text-left">
            <div class="px-8 py-6 ">
              <div class="text-center py-7">
                <h1 class="text-2xl font-bold ">create testimoni here</h1>
              </div>
              <div>
              <label for="desc" class="block font-semibold">desc</label>
              ...
              <div>
              <label for="asal_pt" class="block mt-3 font-semibold">asal_pt</label>
              <input wire:model.defer="asal_pt" id="asal_pt" name="asal_pt" type="text" class="border border-yellow-600  w-full h-5 px-3 py-5 mt-2 hover:outline-none focus:outline-none focus:ring-yellow-700 focus:ring-1 rounded-md">
             </div> 
              <div>
